        ...
        <div class="home-top-content">
            <div class="home-header">
                <div class="leftInfo">
                    ...
                    <em><img src="../../assets/icon/ic_已实名@2x.png" alt=""></em>
                </div>
            ...
            <div class="home-title-info">
                ...
                <div class="bound" >
                    ...
                    <div class="pay-info">
                        ...
                        <div class="quick-payment" @click="toToQuickPay">
                ...
                <div class="myWater-content">
                    ...
                    <div class="myWater-info">
                        ...
                        <van-swipe class="my-swipe" indicator-color="#A2B0C6" show-indicators>
                            <van-swipe-item v-for="(item, index) in authorInfo" :key="index">
                                <div class="current-author-info">
                                    <ul>
                                        <li>
                                            <p>{{item.mounthNum}}<i>吨</i></p>
                                            <em>9月份水量</em>
                                            <span v-if="item.isTitle">待充值</span>
                                        </li>
                                        <li>
                                            <p>{{item.currentYearNum}}<i>吨</i></p>
                                            <em>今年水量</em>
                                            <span v-if="item.isTitle">待充值</span>
                                        </li>
                                        <li>
                                            <p>{{item.moneyNum}}<i>元</i></p>
                                            <em>预存金额</em>
                                            <span v-if="item.isTitle">待充值</span>
                                        </li>
                                    </ul>
...
import myWater_First from '../../assets/icon/ic_golden_自助抄表@2x.png';
import myWater_Second from '../../assets/icon/ic_golden_预存充值@2x.png';
import myWater_Third from '../../assets/icon/ic_golden_电子发票@2x.png';
import myWater_Fourth from '../../assets/icon/ic_golden_用水统计@2x.png';
import myWater_Fifth from '../../assets/icon/ic_golden_用户绑定@2x.png';
...
export default {
  ...
  data () {
    return {
      ...
      authorInfo: [
        { mounthNum: '15', currentYearNum: '98', moneyNum: '100.00', info: '「刘保军」【户号-AA】福州鼓楼区馥郁14栋馥郁14栋馥郁14栋' },
        { mounthNum: '16', currentYearNum: '88', moneyNum: '99.00', info: '「刘保军」【户号-BB】福州鼓楼区馥郁14栋馥郁14栋馥郁14栋' },
      ],
      girdIcon: [
        ...
        .feedback-content {
            ...
            .feedback-info {
                ...
                ul {
                    ...
                    li:first-child {
                        background: url('../../assets/pic_banner_gold_left@2x.png') no-repeat 0 0;
                        background-size: cover;
                    }
                    li:last-child {
                        background: url('../../assets/pic_banner_gold_right@2x.png') no-repeat 0 0;
                        background-size: cover;
                    }
                }
            }
