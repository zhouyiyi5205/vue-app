 ...
 * @LastEditTime: 2020-09-21 08:43:30
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \vue-app-vant\src\views\Home\index.vue
-->
<template>
    <div class="home-page-noRealName">
        <div class="home-top-content">
            <div class="home-header">
                <div class="leftInfo">
                    ...
                    <em @click="goToHomeAll"><img src="../../assets/icon/ic_未实名@2x.png" alt=""></em>
                </div>
            ...
            <div class="home-title-info">
                ...
                <div class="bound" >
                    ...
                    <div class="pay-info">
                        ...
                        <div class="quick-payment" @click="goToQuickPay">
